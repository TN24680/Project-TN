...
#   print('''Choose a starter from the list below jolilly''')
...
(14) Battle other Users (Raju Gandhi Sir special)
           
(s) Save Data
\033[2mData is auto saved 100% \033[0m
(l) Load Data
\033[2mIf you lost your progress, and use this, you will get all the data from 
your last manual save by 100%\033[0m
''')
            print(x)
            input1 = input().strip()
            clear()
            if input1 == '1':
              ...
              clear()
                ...
                if x == '1':
                    if db['Money'] > 500:
                        print(
                            'You bought a Potion!na It has been added to your inventory '
                        )
                        db['Money'] -= 500
                        db['Potions'] += 10
                        affirm()
                        ...
                        print('Aiyiyo Not enough money! ')
                        affirm()
                        clear()
                if x == '2':
                    if db['Money'] > 200:
                        print(
                            'You bought 10 Pokeballs!na They have been added to your inventory '
                        )
                        db['Money'] -= 200
                        db['PokeBalls'] += 10
                        affirm()
                ...
                if x == '3':
                    if db['Money'] > 750:
                        print(
                            "You bought 10 Great Balls!na They have been added to your inventory! "
                        )
                        db['GreatBalls'] += 10
                        db['Money'] -= 750
                        affirm()
                ...
                if x == '4':
                    if db['Money'] > 1000:
                        print(
                            "You bought a Sheening Perfume!na The effect has been applied! "
                        )
                        db['Money'] -= 1000
                        db['Perfume'] += 500
                    else:
                ...
                if x == '8' and db['FIGHT'] == False:
                    if db['Money'] >= 20000:
                        db['Money'] -= 20000
                        db['FIGHT'] = True
                        print('You bought the Critical Gem!(Stanley sir special) ')
                        affirm()
                        clear()
                if x == '5':
                    if db['Money'] >= 1000 + (db['EeveeLv'] * 100):
                        db['EeveeLv'] += 1
                        print(
                            f"You bought a Rare Candy!na Your {db['PokemonName']}  is now level",
                            db['EeveeLv'], "!")
                ...
                if not 'EasterEgg1' in db.keys():
                    ...
                    print(
                        "You greedy little Sir, you want this again? Well you just lost 10 percent of your money. LOL "
                    )
                    affirm()
                    clear()
            elif input1 == '7':
